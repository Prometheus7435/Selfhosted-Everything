...

{
  ...
  virtualisation.oci-containers.containers."nextcloud-aio-tailscale" = {
    ...
    environment = {
      ...
      "TS_STATE_DIR" = "/mnt/alpha/docker/apps/nextcloud_aio_mastercontainer/tailscale";
      "TS_USERSPACE" = "false";
    };
    volumes = [
      "/mnt/alpha/docker/apps/nextcloud_aio_mastercontainer/tailscale:/var/lib/tailscale:rw"
      "/mnt/alpha/docker/apps/nextcloud_aio_mastercontainer/tls:/mnt/tls:rw"
    ];
    ports = [
      "80:80/tcp"
      "8180:8080/tcp"
